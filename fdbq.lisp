...
(defmethod gen-field-clause ((op (eql 'like)) field1 field2 line-var)
  (cond ((null (field-filter field2))   ;regex is a field
        ...
        ((simple-regex? (field-filter field2))
...
(defun gen-field-op (clause line-var spec)
  (destructuring-bind (op field1 field2) clause
    (gen-field-clause op (get-field-dim field1 spec)
                      (get-field-dim field2 spec) line-var)))
